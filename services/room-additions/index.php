...
$ogImage         = $clientPhotos['photo_room_additions'];
$heroPreloadImage = $clientPhotos['photo_room_additions'];
...
.ra-hero {
  ...
  align-items: center;
  overflow: hidden;
  background-image: url('<?php echo $clientPhotos['photo_room_additions']; ?>');
