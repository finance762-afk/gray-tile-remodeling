<?php
/**
 * nav.php — Gray Tile & Remodeling
 * Navigation component: skip-link, fixed glassmorphism navbar with scroll transition,
 * desktop mega-dropdown, mobile hamburger menu with full-screen overlay.
 *
 ...
 *
 * NOTE: Pages in this build include includes/header.php which renders this navigation.
 * This file exists as the canonical nav component reference and for QA validation.
 */
if (!isset($siteName)) {
...
// Guard: header.php already rendered the nav if included first
if (defined('GRAY_TILE_HEADER_RENDERED')) {
    return;
}
?>
...
<!-- sticky fixed navbar — adds .scrolled class on scroll via main.js (glassmorphism + backdrop-filter) -->
